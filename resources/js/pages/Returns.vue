...
const faqs = ref([
    ...
    },
    {
        ...
        answer: 'Contact our support team with your order number and reason for return. We\'ll provide you with a return authorization number and shipping instructions.',
        isOpen: false
    },
    {
        question: 'Who pays for return shipping?',
        answer: 'For defective or incorrect items, we cover return shipping costs. For other returns, shipping fees are the customer\'s responsibility.',
        isOpen: false
    },
    {
    ...
    },
    {
        ...
        answer: 'Yes! We offer exchanges for different colors, sizes, or models. Contact our support team to arrange an exchange.',
        isOpen: false
    }
]);
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 bg-[#0071e3]/10 dark:bg-[#0a84ff]/10 rounded-full flex items-center justify-center">
                                    <svg class="w-6 h-6 text-[#0071e3] dark:text-[#0a84ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6] leading-relaxed">
                                    You have 30 days from the date of delivery to return any item for a full refund or exchange. The product must be in its original condition with all accessories and packaging intact.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6] leading-relaxed">
                                    Items must be unused, unworn, and in the same condition that you received them. They must also be in the original packaging with all tags attached.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6 sm:space-y-8">
                        ...
                        <div class="flex items-start space-x-4 sm:space-x-6">
                            ...
                            <div class="flex-1 pt-1">
                                ...
                                <p class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6] leading-relaxed">
                                    Reach out to our support team via email or chat with your order number and reason for return. We'll provide you with a Return Authorization (RA) number.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4 sm:space-x-6">
                            ...
                            <div class="flex-1 pt-1">
                                ...
                                <p class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6] leading-relaxed">
                                    Securely pack the item in its original packaging with all accessories, manuals, and tags. Include a copy of your order confirmation and the RA number.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4 sm:space-x-6">
                            ...
                            <div class="flex-1 pt-1">
                                ...
                                <p class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6] leading-relaxed">
                                    Use the prepaid shipping label we provide (for defective items) or arrange your own shipping. We recommend using a trackable shipping service.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4 sm:space-x-6">
                            ...
                            <div class="flex-1 pt-1">
                                ...
                                <p class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6] leading-relaxed">
                                    Once we receive and inspect your return, we'll process your refund within 5-7 business days. You'll receive an email confirmation when it's complete.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-[#1d1d1f] rounded-3xl shadow-sm border border-[#d2d2d7] dark:border-[#424245] p-6 sm:p-10 mb-8 sm:mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        <div class="flex items-start space-x-3">
                            <svg class="w-5 h-5 text-[#86868b] dark:text-[#a1a1a6] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6]">Items without original packaging</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-5 h-5 text-[#86868b] dark:text-[#a1a1a6] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6]">Items showing signs of use or wear</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-5 h-5 text-[#86868b] dark:text-[#a1a1a6] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6]">Items damaged due to misuse</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-5 h-5 text-[#86868b] dark:text-[#a1a1a6] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-sm sm:text-base text-[#86868b] dark:text-[#a1a1a6]">Items returned after 30 days</span>
                        </div>
                    </div>
                </div>
