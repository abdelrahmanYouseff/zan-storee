...
const secondaryImagesPreviews = ref([]);
        ...
        <div class="container mx-auto p-6">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground mt-1">Add a new product to your store</p>
                </div>
                ...
                <div class="grid gap-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Upload product images (JPG, PNG, GIF, WEBP - Max 2MB)</CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-4">
                            <div class="space-y-2">
